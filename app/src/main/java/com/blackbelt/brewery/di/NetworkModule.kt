...
import com.blackbelt.brewery.api.ApiKeyInterceptor
import com.blackbelt.brewery.api.BreweryApiService
...
class NetworkModule {
    ...
    @Provides
    @Singleton
    fun provideGsonConverterLibrary(gson: Gson): GsonConverterFactory {
    ...
    @Provides
    @Singleton
    fun provideBreweryApiServie(
            okHttpClient: OkHttpClient,
            gsonConverterFactory: GsonConverterFactory,
            rxJava2CallAdapterFactory: RxJava2CallAdapterFactory): BreweryApiService {
